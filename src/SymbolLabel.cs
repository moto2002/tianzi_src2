...
{
	private const string strFileName = "SymbolFont";
	...
	{
		AtlasManager.GetFont("SymbolFont", this.m_SymbolLabel.gameObject, new AssetCallBack(this.OnLoadComplete));
	}
	...
	private void OnLoadComplete(VarStore args)
	{
		...
		if (uIFont != null)
		{
			this.m_SymbolLabel.bitmapFont = uIFont;
		}
	}
	...
	private void Awake()
	{
		...
		{
			this.m_TextLabel.bitmapFont = Config.SnailFont;
		}
		this.m_TextLabel.FontName = "NGUIFont";
		...
		UIWidget arg_21E_0 = this.m_SymbolLabel;
		int height = 10;
		this.m_SymbolLabel.height = height;
		arg_21E_0.width = height;
	}
	...
	{
		if (this.m_SymbolLabel.bitmapFont != null)
		{
			DelegateProxy.PopCache(this.m_SymbolLabel.bitmapFont);
		}
		AtlasManager.PopFont("SymbolFont", this.m_SymbolLabel.gameObject);
	}
}
