...
{
	private const float SmallRatio = 1.33333337f;

	private const double dsmallRatioPixles = 1769472.0;

	public const float BigRatio = 1.77777779f;

	private const double dbigRatioPixles = 1440000.0;
	...
	{
		this.currentResolution.x = (float)width;
		this.currentResolution.y = (float)height;
