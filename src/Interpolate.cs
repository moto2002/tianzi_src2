...
public class Interpolate
{
	...
	{
		Interpolate.<NewTimer>c__IteratorD <NewTimer>c__IteratorD = new Interpolate.<NewTimer>c__IteratorD();
		<NewTimer>c__IteratorD.duration = duration;
		<NewTimer>c__IteratorD.<$>duration = duration;
		Interpolate.<NewTimer>c__IteratorD expr_15 = <NewTimer>c__IteratorD;
		expr_15.$PC = -2;
		return expr_15;
	}
	...
	{
		Interpolate.<NewCounter>c__IteratorE <NewCounter>c__IteratorE = new Interpolate.<NewCounter>c__IteratorE();
		<NewCounter>c__IteratorE.start = start;
		<NewCounter>c__IteratorE.end = end;
		<NewCounter>c__IteratorE.step = step;
		<NewCounter>c__IteratorE.<$>start = start;
		<NewCounter>c__IteratorE.<$>end = end;
		<NewCounter>c__IteratorE.<$>step = step;
		Interpolate.<NewCounter>c__IteratorE expr_31 = <NewCounter>c__IteratorE;
		expr_31.$PC = -2;
		return expr_31;
	}
	...
	{
		Interpolate.<NewEase>c__IteratorF <NewEase>c__IteratorF = new Interpolate.<NewEase>c__IteratorF();
		<NewEase>c__IteratorF.end = end;
		<NewEase>c__IteratorF.start = start;
		<NewEase>c__IteratorF.driver = driver;
		<NewEase>c__IteratorF.ease = ease;
		<NewEase>c__IteratorF.total = total;
		<NewEase>c__IteratorF.<$>end = end;
		<NewEase>c__IteratorF.<$>start = start;
		<NewEase>c__IteratorF.<$>driver = driver;
		<NewEase>c__IteratorF.<$>ease = ease;
		<NewEase>c__IteratorF.<$>total = total;
		return <NewEase>c__IteratorF;
	}
	...
	{
		Interpolate.<NewBezier>c__Iterator10<T> <NewBezier>c__Iterator = new Interpolate.<NewBezier>c__Iterator10<T>();
		...
		<NewBezier>c__Iterator.<$>ease = ease;
		<NewBezier>c__Iterator.<$>maxStep = maxStep;
		Interpolate.<NewBezier>c__Iterator10<T> expr_4F = <NewBezier>c__Iterator;
		expr_4F.$PC = -2;
		return expr_4F;
	}
	...
	{
		Interpolate.<NewCatmullRom>c__Iterator11<T> <NewCatmullRom>c__Iterator = new Interpolate.<NewCatmullRom>c__Iterator11<T>();
		...
		<NewCatmullRom>c__Iterator.<$>loop = loop;
		<NewCatmullRom>c__Iterator.<$>slices = slices;
		Interpolate.<NewCatmullRom>c__Iterator11<T> expr_3F = <NewCatmullRom>c__Iterator;
		expr_3F.$PC = -2;
		return expr_3F;
	}
