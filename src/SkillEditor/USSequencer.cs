...
namespace SkillEditor
{
	...
	public class USSequencer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			if (this.autoplay && Application.isPlaying)
			{
				this.Play();
			}
		}
		...
		{
			USSequencer.<UpdateSequencerCoroutine>c__Iterator17 <UpdateSequencerCoroutine>c__Iterator = new USSequencer.<UpdateSequencerCoroutine>c__Iterator17();
