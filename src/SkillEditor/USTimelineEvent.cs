...
namespace SkillEditor
{
	public class USTimelineEvent : USTimelineBase
	{
		...
		public USEventBase Event(int index)
		{
			...
			{
				Debug.LogWarning("Trying to access an element in mEventList that does not exist from USTimelineEvent::Event");
				return null;
			}
		...
		public void RemoveAndDestroyEvent(Transform sequencerEvent)
		{
			...
			{
				Debug.LogWarning("We are trying to delete an Event that doesn't belong to this Timeline, from USTimelineEvent::RemoveAndDestroyEvent");
				return;
			}
