...
public class NcUvAnimation : NcEffectAniBehaviour
{
	...
	public override void ResetAnimationForNcDelayActive()
	{
		this.Reset();
	}
	...
	private void Start()
	{
		...
		{
			this.m_SharedMat = this.m_Renderer.sharedMaterial;
		}
		if (this.m_Renderer == null || this.m_SharedMat == null || this.m_SharedMat.mainTexture == null)
		{
			base.enabled = false;
		}
		else
	...
	private void Update()
	{
		if (this.m_Renderer == null || this.m_SharedMat == null || this.m_SharedMat.mainTexture == null || this.m_Timer == null)
		{
			return;
		}
		Vector2 zero = Vector2.zero;
