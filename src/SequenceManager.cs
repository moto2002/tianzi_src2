...
{
	public delegate void CGPlayComplete(int taskId, GameObject role);
	...
	public delegate void DelegateLoadAsset(string strFileName, AssetCallBack callback, VarStore store = null);
	...
	public void Start(GameObject sequencer, GameObject mainRole, GameObject camera, SequenceManager.CGPlayComplete callFunc, int taskId = 0)
	{
		if (this.mMovie == null)
		{
