...
namespace SkillEditor.Shared
{
	public static class StringExtensions
	{
		...
		{
			StringExtensions.<Split>c__Iterator15 <Split>c__Iterator = new StringExtensions.<Split>c__Iterator15();
			<Split>c__Iterator.str = str;
			<Split>c__Iterator.controller = controller;
			<Split>c__Iterator.<$>str = str;
			<Split>c__Iterator.<$>controller = controller;
			StringExtensions.<Split>c__Iterator15 expr_23 = <Split>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
