...
namespace SkillEditor.Shared
{
	public static class LinqExts
	{
		...
		{
			LinqExts.<FromItems>c__Iterator14<T> <FromItems>c__Iterator = new LinqExts.<FromItems>c__Iterator14<T>();
			<FromItems>c__Iterator.items = items;
			<FromItems>c__Iterator.<$>items = items;
			LinqExts.<FromItems>c__Iterator14<T> expr_15 = <FromItems>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
