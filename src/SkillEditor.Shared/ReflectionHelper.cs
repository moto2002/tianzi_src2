...
namespace SkillEditor.Shared
{
	public class ReflectionHelper : IReflectionHelper
	{
		...
		{
			ReflectionHelper.<GetBaseTypes>c__Iterator16 <GetBaseTypes>c__Iterator = new ReflectionHelper.<GetBaseTypes>c__Iterator16();
			<GetBaseTypes>c__Iterator.type = type;
			<GetBaseTypes>c__Iterator.<$>type = type;
			<GetBaseTypes>c__Iterator.<>f__this = this;
			ReflectionHelper.<GetBaseTypes>c__Iterator16 expr_1C = <GetBaseTypes>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
