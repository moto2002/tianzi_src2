...
public class UIWidget : UIRect
{
	...
	protected bool colliderInit;

	protected bool isMakePixelPerfect;

	public OnActionCallback onMarkAsChangedEvent;
	...
	{
		if (box == null || !this.autoResizeBoxCollider)
		{
			return;
		}
		if (box.transform != base.transform)
		{
			return;
		}
		this.mCollider = box;
	...
	{
		if (NGUITools.GetActive(this) && this.mCollider != null)
		{
			NGUITools.UpdateWidgetCollider(this, this.mCollider, true);
		}
	}
	...
	public virtual void MarkAsChanged()
	{
		if (NGUITools.GetActive(this))
		{
			...
			if (this.isMakePixelPerfect)
			{
				this.isMakePixelPerfect = false;
			...
			if (this.onMarkAsChangedEvent != null)
			{
				this.onMarkAsChangedEvent();
			}
		}
	}
	...
	public virtual void CheckLoadAtlas()
	{
	}
	...
	public void OnWidgetDestroy()
	{
		if (Application.isPlaying)
		{
			...
			{
				UILabel uILabel = this as UILabel;
				if (uILabel != null && uILabel.bitmapFont != null && !string.IsNullOrEmpty(uILabel.FontName))
				{
			...
			if (this is UISprite)
			{
				UISprite uISprite = this as UISprite;
				if (uISprite != null && uISprite.atlas != null && !string.IsNullOrEmpty(uISprite.AtlasName))
				{
					uISprite.atlas = null;
				}
			}
	...
	{
		this.RemoveFromPanel();
		this.onMarkAsChangedEvent = null;
		this.OnWidgetDestroy();
	}
