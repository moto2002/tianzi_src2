...
{
	public delegate string U3DReturnAndroidLanguage();

	public delegate void PopCacheDelegateProxy(UnityEngine.Object o);

	public delegate bool PushCacheDelegateProxy(string strName, UnityEngine.Object o);
	...
	public delegate void LoadAssetDelegateProxy(string strFileName, bool cache, AssetCallBack back, VarStore store = null);

	public delegate void UnloadAssetDelegateProxy(object[] args);

	public delegate void OnDespawnedDelegateProxy(Transform trans);
	...
	public static DelegateProxy.U3DReturnAndroidLanguage ReturnAndroidLanguage;

	public static DelegateProxy.PopCacheDelegateProxy PopCacheProxy;

	public static DelegateProxy.PushCacheDelegateProxy PushCacheProxy;
	...
	public static DelegateProxy.OnDespawnedDelegateProxy DespawnedProxy;
	...
	public static string U3DReturnAndroid()
	{
		if (DelegateProxy.ReturnAndroidLanguage != null)
		{
			return DelegateProxy.ReturnAndroidLanguage();
		}
		return string.Empty;
	}
	...
	public static void PushCache(string strName, UnityEngine.Object o)
	{
		if (DelegateProxy.PushCacheProxy != null)
		{
			DelegateProxy.PushCacheProxy(strName, o);
		}
	}
	...
	public static bool LoadAsset(string strFileName, AssetCallBack callback, bool cache = true)
	{
		if (DelegateProxy.LoadAssetProxy != null)
		{
			DelegateProxy.LoadAssetProxy(strFileName, cache, callback, null);
			return true;
		}
		return false;
	}
